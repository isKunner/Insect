...
class Vgg16_config():
    def __init__(self, train_dl, val_dl, train_num, val_num, epochs=20, lr=0.001):
        ...
        self.epochs = epochs
        self.net = vgg()  # 两种类别，有虫或没虫
        self.model_weight_path = None
        # self.model_weight_path = "./vgg16.pth"  # load pretrain weights  download url: https://download.pytorch.org/models/shufflenetv2_x1-5666bf0f80.pth
        self.save_path = "./vgg_weight.pth" # 保存模型权重的未知
...
def main():
    ...
    myconfig = Vgg16_config(datas.train_dl, datas.val_dl, datas.train_num, datas.val_num)
